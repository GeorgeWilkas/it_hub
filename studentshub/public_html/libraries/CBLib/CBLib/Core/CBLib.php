...
define( 'CBLIB', '2.9.1' );	// IMPORTANT: when changing version here also change in cbInstallerPlugin.php, the 8 XML installation files and build.xml and just below
...
class CBLib
{
	protected static $THISCBVERSION		=	'2.9.1+build.2024.02.09.12.14.46.83d67ccd3';	 	// IMPORTANT: DO NOT CHANGE MANUALLY, but when changing version automatically here also change in cbInstallerPlugin.php, the 8 XML installation files and build.xml and just above
