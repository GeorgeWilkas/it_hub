...
return	array(
// 25 language strings from file cbgroupjiveevents/cbgroupjiveevents.xml
'ENABLE_OR_DISABLE_AUTOMATIC_DELETION_OF_EVENTS_WHE_7cba1b'	=>	'Enable or disable automatic deletion of events when a user is deleted.',
...
'SELECT_THE_FIELD_TO_USE_FOR_EVENTS_CREATE_LIMIT_PE_a2f1d0'	=>	'Select the field to use for events create limit per group. Moderators are exempt from this configuration.',
'CUSTOM_8b9035'	=>	'custom',
'INPUT_NUMBER_OF_EVENTS_EACH_INDIVIDUAL_USER_IS_LIM_642e5d'	=>	'Input number of events each individual user is limited to creating per group. If blank allow unlimited photos.',
...
'OPTIONALLY_INPUT_THE_ADDRESS_FOR_THIS_EVENT_c53e3d'	=>	'Optionally input the address for this event.',
...
// 3 language strings from file cbgroupjiveevents/library/Trigger/AdminTrigger.php
'EVENTS_87f9f7'	=>	'Events',
'ADD_NEW_EVENT_TO_GROUP_16a334'	=>	'Add New Event to Group',
'EVENT_ATTENDANCE_5c872e'	=>	'Event Attendance',
// 4 language strings from file cbgroupjiveevents/library/Trigger/EventsTrigger.php
...
// 30 language strings from file cbgroupjiveevents/templates/default/activity.php
'EVENT_AWAITING_APPROVAL_IN_YOUR_GROUP'	=>	'event [event] is awaiting approval in your group [group]',
'EVENT_AWAITING_APPROVAL_IN_GROUP'	=>	'event [event] is awaiting approval in group [group]',
'EVENT_APPROVED_IN_YOUR_GROUP'	=>	'event [event] approved in your group [group]',
'EVENT_APPROVED_IN_GROUP'	=>	'event [event] approved in group [group]',
'EVENT_EDITED_IN_YOUR_GROUP'	=>	'edited event [event] in your group [group]',
'EVENT_EDITED_IN_GROUP'	=>	'edited event [event] in group [group]',
'ATTEND_EVENT_IN_YOUR_GROUP'	=>	'attending event [event] in your group [group]',
'ATTEND_EVENT_IN_GROUP'	=>	'attending event [event] in group [group]',
'UNATTEND_EVENT_IN_YOUR_GROUP'	=>	'no longer attending event [event] in your group [group]',
'UNATTEND_EVENT_IN_GROUP'	=>	'no longer attending event [event] in group [group]',
'MESSAGE_FROM_EVENT_IN_YOUR_GROUP'	=>	'message from event [event] in your group [group]',
'MESSAGE_FROM_EVENT_IN_GROUP'	=>	'message from event [event] in group [group]',
...
'ATTEND_EVENT_2a6d78'	=>	'Attend Event',
'ATTENDING_AN_EVENT_f53ee2'	=>	'attending an event',
'ATTENDING_AN_EVENT_IN_YOUR_GROUP'	=>	'attending an event in your group [group]',
'ATTENDING_AN_EVENT_IN_GROUP'	=>	'attending an event in group [group]',
'SCHEDULED_AN_EVENT_6275da'	=>	'scheduled an event',
'SCHEDULED_AN_EVENT_IN_YOUR_GROUP'	=>	'scheduled an event in your group [group]',
...
// 2 language strings from file cbgroupjiveevents/templates/default/attending.php
...
// 10 language strings from file cbgroupjiveevents/templates/default/events.php
'GROUP_EVENTS_COUNT'	=>	'%%COUNT%% Event|%%COUNT%% Events',
'CREATE_NEW_EVENT_19b36f'	=>	'Create New Event',
...
// 1 language strings from file cbgroupjiveevents/templates/default/message.php
