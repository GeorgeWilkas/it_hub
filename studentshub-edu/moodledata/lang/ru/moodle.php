...
$string['eventsectionviewed'] = 'Секция просмотрена';
...
$string['markthistopic'] = 'Выделить секцию как текущую';
...
$string['sites'] = 'Сайты';
$string['sitesection'] = 'Добавить секцию настраиваемого контента';
