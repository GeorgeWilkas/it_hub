...
return	array(
// 8 language strings from file plug_cbprivacy/cbprivacy.xml
'DISABLE_ME_e34c7e'	=>	'Disable Me',
'DELETE_ME_311f9c'	=>	'Delete Me',
'EXPORT_DATA_2f1fb3'	=>	'Export Data',
...
'EXPORT_ACCOUNT_c490d0'	=>	'Export Account',
'BLOCKING_bd0ca6'	=>	'Blocking',
// 6 language strings from file plug_cbprivacy/xml/models/model.privacy.xml
'REQUEST_DISABLED_58fda8'	=>	'Request Disabled',
'REQUEST_DELETED_63f801'	=>	'Request Deleted',
'PENDING_REENABLE_58461f'	=>	'Pending Re-enable',
'SAME_AS_GLOBAL_540a68'	=>	'Так же как в общих настройках',
'ENABLE_2faec1'	=>	'Включить',
'BUTTON_87b776'	=>	'Button',
// 12 language strings from file plug_cbprivacy/xml/views/view.com_comprofiler.cbprivacyoverrides.xml
...
'OPTIONALLY_ADD_A_CLASS_SUFFIX_TO_SURROUNDING_SPAN__e21141'	=>	'Optionally add a class suffix to surrounding SPAN encasing all of CB Privacy. Note global class will also be applied.',
...
// 2 language strings from file plug_cbprivacy/xml/views/view.com_comprofiler.editblockedrow.xml
'INPUT_THE_USER_BLOCKING_AS_SINGLE_INTEGER_USERID_728f52'	=>	'Input the user blocking as single integer user_id.',
'INPUT_BLOCKED_USER_AS_SINGLE_INTEGER_USERID_0c6e9d'	=>	'Input blocked user as single integer user_id.',
// 4 language strings from file plug_cbprivacy/xml/views/view.com_comprofiler.editprivacyrow.xml
...
// 2 language strings from file plug_cbprivacy/xml/views/view.com_comprofiler.showblockedrows.xml
'BLOCKED_ASCENDING_5172d8'	=>	'Blocked ascending',
'BLOCKED_DESCENDING_e5b71d'	=>	'Blocked descending',
