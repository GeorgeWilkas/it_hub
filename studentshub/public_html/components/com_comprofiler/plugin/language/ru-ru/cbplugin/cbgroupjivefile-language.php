...
return	array(
// 14 language strings from file cbgroupjivefile/cbgroupjivefile.xml
'ENABLE_OR_DISABLE_AUTOMATIC_DELETION_OF_FILES_WHEN_810e74'	=>	'Enable or disable automatic deletion of files when a user is deleted.',
'SELECT_THE_FIELD_TO_USE_FOR_FILES_CREATE_LIMIT_PER_a5b691'	=>	'Select the field to use for files create limit per group. Moderators are exempt from this configuration.',
'CUSTOM_8b9035'	=>	'custom',
'INPUT_NUMBER_OF_FILES_EACH_INDIVIDUAL_USER_IS_LIMI_94072e'	=>	'Input number of files each individual user is limited to creating per group. If blank allow unlimited photos.',
...
// 2 language strings from file cbgroupjivefile/library/Trigger/AdminTrigger.php
'FILES_91f3a2'	=>	'Files',
'ADD_NEW_FILE_TO_GROUP_518801'	=>	'Add New File to Group',
// 4 language strings from file cbgroupjivefile/library/Trigger/FileTrigger.php
...
// 13 language strings from file cbgroupjivefile/templates/default/activity.php
'FILE_AWAITING_APPROVAL_IN_YOUR_GROUP'	=>	'file [file] is awaiting approval in your group [group]',
'FILE_AWAITING_APPROVAL_IN_GROUP'	=>	'file [file] is awaiting approval in group [group]',
'FILE_APPROVED_IN_YOUR_GROUP'	=>	'file [file] approved in your group [group]',
'FILE_APPROVED_IN_GROUP'	=>	'file [file] approved in group [group]',
'SHARED_FILE_IN_YOUR_GROUP'	=>	'shared file [file] in your group [group]',
'SHARED_FILE_IN_GROUP'	=>	'shared file [file] in group [group]',
'SHARED_A_FILE_55b22c'	=>	'shared a file',
'SHARED_A_FILE_IN_YOUR_GROUP'	=>	'shared a file in your group [group]',
'SHARED_A_FILE_IN_GROUP'	=>	'shared a file in group [group]',
'TYPE_a1fa27'	=>	'Тип',
'SIZE_6f6cb7'	=>	'Size',
...
// 8 language strings from file cbgroupjivefile/templates/default/files.php
'GROUP_FILES_COUNT'	=>	'%%COUNT%% File|%%COUNT%% Files',
'UPLOAD_NEW_FILE_72e0a5'	=>	'Upload New File',
